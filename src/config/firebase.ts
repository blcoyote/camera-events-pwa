...
import { type MessagePayload, getToken, onMessage, getMessaging } from 'firebase/messaging';
...
export const getMessageToken = (setTokenFound: React.Dispatch<React.SetStateAction<string | undefined>>) => {
